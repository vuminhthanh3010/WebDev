		...
		<div class="container">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12 col-md-8">
					<article>
						<div class="col-xs-12"><p class="title">Các sản phẩm dưới <?php echo $gia1; ?> Triệu VNĐ</p></div>
						<?php
							$price = $x->get_productPrice($gia);
							$count = 0;
							while ($set = $price -> fetch()):
						?>
				...
				<div class="col-xs-12 col-sm-12 col-md-4">
					<aside>
						...
						<a href="../controller/index.php?action=productbrand&id=1">APPLE</a>
						<a href="../controller/index.php?action=productbrand&id=2">SAMSUNG</a>
						<a href="../controller/index.php?action=productbrand&id=3">OPPO</a>
						<a href="../controller/index.php?action=productbrand&id=4">VIVO</a>
						<a href="#">SONY</a>
						<a href="#">HTC</a>
						<a href="#">NOKIA</a>
						<a href="#">ASUS</a>
