<?php include'../view/header.php'; 
	...
	$brand_id = $product[8];
	$brandname = $detail->get_brandId($brand_id);
?>
			...
			<div class="row">
				<div class="menu-detail col-xs-12">
					<ol class="breadcrumb">
					  ...
					  <li><a href="../controller/index.php">Sản Phẩm</a></li>
					  <li class="active"><a href="#"><?php echo $brandname[1]; ?></a></li>
					</ol>
				</div>
				<div class="col-xs-12">
				...
				<div class="col-xs-12 col-sm-4 col-md-4">
					...
					<h3>Khuyến mãi</h3>
					<span class="glyphicon glyphicon-gift"></span><p>Trả góp lãi suất 0% của FE Credit hoặc Home Credit trên giá niêm yết. Áp dụng đến hết ngày 31/7/2018 và không áp dụng đồng thời các khuyến mãi khác.</p><br>
