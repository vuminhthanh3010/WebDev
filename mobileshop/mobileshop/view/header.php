...
<!-- Giá -->
			          <li class="dropdown">
			            ...
			            <ul class="dropdown-menu">
			              <li><a href="?action=productbrand_gia&gia=3">Dưới 3 Triệu</a></li>
			              <li><a href="?action=productbrand_gia&gia=5">Dưới 5 Triệu</a></li>
			              <li><a href="?action=productbrand_gia&gia=10">Dưới 10 Triệu</a></li>
			              <li><a href="?action=productbrand_gia&gia=20">Trên 20 Triệu</a></li>
			            </ul>
			          </li>
