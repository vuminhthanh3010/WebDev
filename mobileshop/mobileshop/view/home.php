		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12">
					<h3 class="title" style="border-left: 9px solid #8bc34a;"><a href="?action=productbrand&id=1">APPLE</a></h3>
					<div class="row">
						<?php
				...
				<div class="col-xs-12 col-sm-12 col-md-12">
					<h3 class="title" style="border-left: 9px solid #d9534f;"><a href="?action=productbrand&id=2">SAMSUNG</a></h3>
					<div class="row">
						<?php
				...
				<div class="col-xs-12 col-sm-12 col-md-12">
					<h3 class="title" style="border-left: 9px solid #f0ad4e;"><a href="?action=productbrand&id=3">OPPO</a></h3>
					<div class="row">
						<?php
				...
				<div class="col-xs-12 col-sm-12 col-md-12">
					<h3 class="title" style="border-left: 9px solid #337ab7;"><a  href="?action=productbrand&id=4">VIVO</a></h3>
					<div class="row">
						<?php
