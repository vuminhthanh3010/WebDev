...
<body>
    ...
    <section id="page-wrapper">
            <div class="row">
                <div class="col-xs-12">
                    <h3 class="alert alert-info" >Các hãng hiện thời</h3>
                    <a href="?action=adminaddcompany" class="btn btn-primary pull-right">Thêm hãng mới</a>
                </div>
                    ...
                    <table class="table table-striped">
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                              <a href="?action=editcompany&id=<?php echo $set[0]; ?>" class="btn btn-success">Sửa</a>
                              <a href="?action=deletebrand&id=<?php echo $set[0]; ?>" class="btn btn-danger">Xóa</a>
                          </td>
                        </tr>
                      <?php } ?>
                      </tbody>
