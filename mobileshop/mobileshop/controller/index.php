<?php  
    ...
    switch($action) {
        ...
        case 'productbrand':
            ...
            break;
        case 'productbrand_gia':
            include("../view/product_gia.php");
            break;
        case 'addproduct':
            if(isset($_SESSION['admin']) || isset($_SESSION['adminh'])){
                pay($_GET['id'],'1');
        ...
        case 'adproduct':
            ...
            break;
        case 'adcompany':
            include '../view/admin/ad-company.php';
            break;
        case 'admember':
        ...
        case 'editproduct':
            ...
            break;
        case 'editcompany':
            include '../view/admin/editcompany.php';
            break;
        case 'editactive':
            $name = $_POST['name'];
            $price = $_POST['price'];
        ...
        case 'editactivecp':
            ...
            $z = new m_product();
            $hinh = $z->get_productId($_GET['id']);
            $id = $hinh['product_brand_id'];

            $update = $z->update_cpn($id,$name);
            echo "<script>alert('Sửa sản phẩm thành công!');</script>";
            include '../view/admin/ad-company.php';
            break;
        case 'deleteproduct':
        ...
        case 'adminaddproduct':
            ...
            break;
        case 'adminaddcompany':
            include '../view/admin/addcompany.php';
            break;
        case 'adminadd':
            $idpro = rand();
            $name = $_POST['name'];
